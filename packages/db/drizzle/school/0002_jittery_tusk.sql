...
CREATE INDEX "evaluation_batchId_studentId_idx" ON "evaluation" USING btree ("batchId","studentId");--> statement-breakpoint
CREATE INDEX "exam_batchId_studentId_idx" ON "exam" USING btree ("batchId","studentId");