...
CREATE INDEX "deviceLinkCode_userId_idx" ON "deviceLinkCode" USING btree ("userId");--> statement-breakpoint
...
CREATE UNIQUE INDEX "member_organizationId_userId_uidx" ON "member" USING btree ("organizationId","userId");--> statement-breakpoint
