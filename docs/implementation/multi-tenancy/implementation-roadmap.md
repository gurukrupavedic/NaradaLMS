...
1. **4.1 Tenant config package**
  - `config/tenants/slmts/`, `config/tenants/rr/` (or repo-equivalent path) with typed config + assets.
    - Document `npm` scripts: SLMTS on `3000`, RR on `3001` (admin `3010`, API `5000` unchanged).
