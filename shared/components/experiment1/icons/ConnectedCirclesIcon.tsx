/**
 * EXPERIMENT 1: Connected Circles Icon Component
 * 
 * Shared icon component for indicating mapped/connected segments.
 * Extracted from duplicate SVG definitions across experiment components.
 * 
 * Status: Experimental - Do not use in production
 * Created: January 2025
 * Purpose: Eliminate duplicate icon definitions in experiment
 */
