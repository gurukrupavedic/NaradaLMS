...
const variantClasses = {
  blue: {
    checked: "bg-gradient-to-br from-blue-500 to-blue-600 border-blue-500 shadow-[0_4px_14px_rgba(59,130,246,0.8)]",
    ...
    dot: "bg-white shadow-sm"
  },
  green: {
    checked: "bg-gradient-to-br from-green-500 to-green-600 border-green-500 shadow-[0_4px_14px_rgba(34,197,94,0.8)]",
  ...
  purple: {
    checked: "bg-gradient-to-br from-purple-500 to-purple-600 border-purple-500 shadow-[0_4px_14px_rgba(139,92,246,0.8)]",
  ...
  orange: {
    checked: "bg-gradient-to-br from-orange-500 to-orange-600 border-orange-500 shadow-[0_4px_14px_rgba(245,158,11,0.8)]",
  ...
  pink: {
    checked: "bg-gradient-to-br from-pink-500 to-pink-600 border-pink-500 shadow-[0_4px_14px_rgba(236,72,153,0.8)]",
  ...
  indigo: {
    checked: "bg-gradient-to-br from-indigo-500 to-indigo-600 border-indigo-500 shadow-[0_4px_14px_rgba(99,102,241,0.8)]",
  ...
  teal: {
    checked: "bg-gradient-to-br from-teal-500 to-teal-600 border-teal-500 shadow-[0_4px_14px_rgba(20,184,166,0.8)]",
  ...
  cyan: {
    checked: "bg-gradient-to-br from-cyan-500 to-cyan-600 border-cyan-500 shadow-[0_4px_14px_rgba(6,182,212,0.8)]",
  ...
  yellow: {
    checked: "bg-gradient-to-br from-yellow-500 to-yellow-600 border-yellow-500 shadow-[0_4px_14px_rgba(234,179,8,0.8)]",
  ...
  lime: {
    checked: "bg-gradient-to-br from-lime-500 to-lime-600 border-lime-500 shadow-[0_4px_14px_rgba(101,163,13,0.8)]",
  ...
  rose: {
    checked: "bg-gradient-to-br from-rose-500 to-rose-600 border-rose-500 shadow-[0_4px_14px_rgba(244,63,94,0.8)]",
  ...
  emerald: {
    checked: "bg-gradient-to-br from-emerald-500 to-emerald-600 border-emerald-500 shadow-[0_4px_14px_rgba(5,150,105,0.8)]",
