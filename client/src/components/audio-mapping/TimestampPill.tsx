...
import { formatTime } from '@shared/utils/text-utils';
...
export const TimestampPill: React.FC<TimestampPillProps> = ({
  ...
  const startEditingTimestamp = () => {
    setIsEditing(true);
    setEditValue(formatTime(endTime));
  };
      ...
      <div className="flex-1 flex items-center justify-center text-gray-700">
        {isEditing ? (
          <div className="flex items-center gap-1">
            ...
            <button onClick={cancelTimestampEdit} className="text-gray-500 hover:text-gray-700">
          ...
          <button
            ...
            className="hover:bg-gray-50 px-1 py-0.5 rounded"
