...
- June 24, 2025. EXPANDED COLOR PALETTE: Extended design system from 6 to 12 vibrant colors by adding teal, cyan, amber, lime, rose, and violet with corresponding fluorescent variants. Updated button showcases with two rows displaying all 12 colors, added complete color palette visualization section, and enhanced both light and dark themes with the new colors including proper hover effects and glow styling.
