 ...
 */
function useReviewRegistrationMutation(
  review: (id: string) => Promise<ApiRegistration>,
...
export function useApproveRegistration() {
  return useReviewRegistrationMutation(approveRegistration, {
    ...
    failure: "Couldn't approve the registration.",
  })
}
...
export function useRejectRegistration() {
  return useReviewRegistrationMutation(rejectRegistration, {
    ...
    failure: "Couldn't reject the registration.",
  })
}
