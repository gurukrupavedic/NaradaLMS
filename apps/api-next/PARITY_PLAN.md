...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------- |
| [DD-001](./decisions/DD-001.md) | Use `translateDbError` as a final race-safe mapping for PostgreSQL unique and foreign-key failures.                                            | Preserve each current endpoint's observed database-error behavior.                                    | proposed |
