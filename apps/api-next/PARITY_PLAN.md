...
| [DD-002](./decisions/DD-002.md) | Keep the draft exam transition state machine, optimistic status guard, transactional single-result winner, and terminal-result checks.         | Preserve the current exam transition/update/result side effects.                                      | agent-approved (pending review) |
