 ...
 * Ported from shared/utils/text-segmentation.ts for Student Portal
 */

import type { EnrichedTextSegment as TextSegment, AudioMapping, Script, ContentMap } from '@narada/types';
