 ...
 *   npx tsx tests/auth-test.ts --auto
 *   npx tsx tests/auth-test.ts --quick --auto
 *   npx tsx tests/auth-test.ts --full --auto
 *   
 * Show Help:
 *   npx tsx tests/auth-test.ts --help
 * 
 * ============================================================================
...
USAGE:
  npx tsx tests/auth-test.ts [OPTIONS]
...
EXAMPLES:
  npx tsx tests/auth-test.ts --quick              # Quick test, server running
  npx tsx tests/auth-test.ts --full               # Full test, server running
  npx tsx tests/auth-test.ts --quick --auto       # Quick test, auto server
  npx tsx tests/auth-test.ts --full --auto        # Full test, auto server
  npx tsx tests/auth-test.ts --auto               # Auto server (defaults to quick)
